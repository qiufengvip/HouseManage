...
<base href="<%=basePath%>">
    ...
    <script src="IG_Public/lib/jquery-1.11.1.min.js" type="text/javascript"></script>
     <script type="text/javascript" src="IG_Public/script/IG_Class.js"></script>
    ...
    <div class="content">
      ...
      <div class="row">
								<div class="col-lg-4">
									<div class="input-group">
										...
										<span class="input-group-btn">
											<button class="btn btn-default" type="button">分类名</button>
										</span> <input type="text" class="form-control" placeholder="请输入分类名"	id="name">
        ...
        <div class="contant" id="vueBox" v-cloak>
           ...
           <Modal v-model="detailModel" draggable scrollable title="分类信息" @on-ok="save" >
