...
import java.util.Properties;
 public class EmailUtil{
		...
		public static String sendEmailAccount = "2427355672@qq.com";
		// 发件人的邮箱的授权码(自己在邮箱服务器中开启并设置)
		public static String sendEmailPassword = "bdgayjztloeyeceb";
		// 发件人邮箱的SMTP服务器地址，如：smtp.163.com
		public static String sendEmailSMTPHost = "smtp.qq.com";//"smtp.163.com";
		// 收件人的邮箱账号
